...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_kanban_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='kanban-view'
        )
        self.assertTrue(view.__name__ == 'kanban-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in kanban-view'
        # )

    def test_kanban_view_not_matching_interface(self):

...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_to_do_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='to-do-view'
        )
        self.assertTrue(view.__name__ == 'to-do-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in to-do-view'
        # )

    def test_to_do_view_not_matching_interface(self):
